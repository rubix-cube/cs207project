...
def test_repr_with_time():
	assert repr(SMTimeSeries([5,7,9], [1,3,5]))=="TimeSeries: [(5, 1), (7, 3), (9, 5)]"

def test_repr_with_time_long():
	assert repr(SMTimeSeries(range(5,34,2),range(1,30,2)))=="TimeSeries: [(5, 1), (7, 3), (9, 5), (11, 7), (13, 9)].....omitting 5 pairs.....[(25, 21), (27, 23), (29, 25), (31, 27), (33, 29)]"

#Test __str__
def test_str_with_time():
	assert str(SMTimeSeries([5,7,9], [1,3,5]))=="TimeSeries: [(5, 1), (7, 3), (9, 5)]"

def test_str_with_time_long():
	assert str(SMTimeSeries(range(5,34,2), range(1,30,2)))=="TimeSeries: [(5, 1), (7, 3), (9, 5), (11, 7), (13, 9)].....omitting 5 pairs.....[(25, 21), (27, 23), (29, 25), (31, 27), (33, 29)]"
