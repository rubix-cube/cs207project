...
def test_repr_with_time():
	assert repr(ArrayTimeSeries([5,7,9], [1,3,5]))=="ArrayTimeSeries: [(5, 1), (7, 3), (9, 5)]"

def test_repr_with_time_long():
	assert repr(ArrayTimeSeries(range(5,34,2),range(1,30,2)))=="ArrayTimeSeries: [(5, 1), (7, 3), (9, 5), (11, 7), (13, 9)].....omitting 5 pairs.....[(25, 21), (27, 23), (29, 25), (31, 27), (33, 29)]"

#Test __str__
def test_str_with_time():
	assert str(ArrayTimeSeries([5,7,9], [1,3,5]))=="ArrayTimeSeries: [(5, 1), (7, 3), (9, 5)]"

def test_str_with_time_long():
	assert str(ArrayTimeSeries(range(5,34,2), range(1,30,2)))=="ArrayTimeSeries: [(5, 1), (7, 3), (9, 5), (11, 7), (13, 9)].....omitting 5 pairs.....[(25, 21), (27, 23), (29, 25), (31, 27), (33, 29)]"
